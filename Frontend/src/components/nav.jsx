   ...
   <>
    <nav className={open? "navOpen wrapperOpen" : "nav wrapper"}>
      ...
      <ul className={open? "nav-open" : "nav__list"}>
        <li className="nav_links"><a href="/home" className="nav__link">Home</a></li>
        <li className="nav_links">
          <a href="product" className="nav__link drop"
            >Products
          </a>
        </li>
        <li className="nav_links"><a href="/about" className="nav__link">About Us</a></li>
        <li className="nav_links">
          <a href="/gallery" className="nav__link drop"
            >Gallery
            <svg
              width="17"
              height="9"
        ...
        <li className="nav_links">
          <a href="/investment" className="nav__link">Investments</a>
        </li>
        <li className="nav_links">
          <a href="/blog" className="nav__link drop"
            >Blog
            <svg
              width="17"
              height="9"
      ...
      <div className="nav__btn">
        <a href="/register" style={{fontSize:"14px"}} className="btn primary__btn green border">Register</a>
         {userInfo? (
           <a href="#logout" style={{fontSize:"14px"}} onClick={signoutHandler}  className="btn primary__btn green border">Logout</a>
           ):(
             <a href="/login" style={{fontSize:"14px"}} className="btn primary__btn green border">Login</a>
          )} 
...
<a href='cart'>
      <svg
          ...
          {cart.cartItems.length > 0 && (
           <a href='/cart' ><span>{cart.cartItems.reduce((a,c)=>a + c.quantity,0)}</span></a>
          )}
</a>
: ""}
{
